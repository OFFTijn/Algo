...
if __name__ == '__main__':
    g = {
        ...
        "302": [("N3.2", 35), ("303", 21), ("301", 21), ("B.3.209", 10), ("B.3.211", 12), ("B.3.213", 14), ("B.3.206", 11), ("B.3.105", 7), ("B.3.103", 9), ("B.3.107", 8), ("B.3.U1", 7)],
        "301": [("302", 21), ("201", 5)],
        ...
        "202": [("N2.2", 35), ("203", 21), ("201", 21), ("B.2.209", 10), ("B.2.211", 12), ("B.2.213", 14), ("B.2.206", 11), ("B.2.105", 7), ("B.2.103", 9), ("B.2.107", 8), ("B.2.U1", 7)],
        ...
        "102": [("N2.2", 35), ("103", 21), ("101", 21), ("B.1.209", 10), ("B.1.211", 12), ("B.1.213", 14), ("B.1.206", 11), ("B.1.105", 7), ("B.1.103", 9), ("B.1.107", 8), ("B.1.U1", 7)],
        ...
        "002": [("003", 18), ("001", 12), ("006", 35), ("H.0.001", 35), ("B.0.U1", 7), ("B.0.201", 3), ("B.0.104", 14), ("B.0.107", 14), ("B.0.205", 0), ("B.0.209", 8), ("B.0.211", 17)],
